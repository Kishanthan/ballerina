            ...
            case TypeTags.CHAR_TAG:
                ...
                if (value != null) {
                    if (value instanceof Character) {
                        structureType.setCharField(index, (Character) value);
                    } else if (value instanceof Integer) {
                        structureType.setCharField(index, (Integer) value);
                    } else if (value instanceof BCharacter) {
                        structureType.setCharField(index, ((BCharacter) value).charValue());
                    }
                }
                break;
            case TypeTags.BYTE_TAG:
                ...
                if (value != null) {
                    if (value instanceof Byte) {
                        structureType.setByteField(index, (Byte) value);
                    } else if (value instanceof Integer) {
                        structureType.setByteField(index, (Integer) value);
                    } else if (value instanceof BByte) {
                        structureType.setByteField(index, ((BByte) value).byteValue());
                    }
                }
                break;
