...
public class JVMFunctionTake0 {
    ...
    public static void main(String[] args) {
        ...
        BObjectType objectType = new BObjectType("Person", 1);
...

        {
            ...
            BType[] retParamTypes = new BType[]{};
            BFunctionType checkAndModifyAgeFnType = new BFunctionType("checkAndModifyAge", paramTypes, retParamTypes,
                    1);
            objectType.addFunctionType(checkAndModifyAgeFnType);
        }

        class Person extends BObject {

            public Person(BObjectType objectType) {
                super(objectType);
            }

            void __init(long age, String firstName, String lastName) {
                this.put("age", age);
            ...
            void checkAndModifyAge(long condition, long a) {
                if (((long) this.get("age")) < condition) {
                    this.put("age", a);
                }
            }
        }

        Person person = new Person(objectType);

        //    Person person =  new(12, "Kicha", "Avi");
        //    string fullName = person.getFullName();
        //    person.checkAndModifyAge(14, 15);
        //    int age = person.age;

        person.__init(12, "Kicha", "Avinash");
        String fullName = person.getFullName();
        person.checkAndModifyAge(14, 15);
