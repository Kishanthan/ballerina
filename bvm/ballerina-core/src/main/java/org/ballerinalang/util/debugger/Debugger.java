        ...
        localVarAttrInfo.getLocalVariables().forEach(l -> {
            ...
            switch (l.getVariableType().getTag()) {
                ...
                case TypeTags.CHAR_TAG:
                    variableDTO.setBValue(new BCharacter(ctx.workerLocal.charRegs[l.getVariableIndex()]));
                    break;
                case TypeTags.BYTE_TAG:
                    variableDTO.setBValue(new BByte(ctx.workerLocal.byteRegs[l.getVariableIndex()]));
                    break;
